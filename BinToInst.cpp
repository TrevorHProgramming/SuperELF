...
inline QString BinToInst::special_inst(int setlist[]) {
    switch(setlist[5]){
        ...
        case 15: return "SYNC " + QString::number(setlist[4]);
        ...
        case 56: return "DSLL " + GGR(setlist[3]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[4]);
        case 58: return "DSRL " + GGR(setlist[3]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[4]);
        case 59: return "DSRA " + GGR(setlist[3]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[4]);
        case 60: return "DSLL32 " + GGR(setlist[3]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[4]);
        case 62: return "DSRL32 " + GGR(setlist[3]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[4]);
        case 63: return "DSRA32 " + GGR(setlist[3]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[4]);
    }
...
inline QString BinToInst::MMI_inst(int setlist[]) {
    switch (setlist[5]) {
        ...
        case 16: return "MFHI1 " + GGR(setlist[3]);
        case 17: return "MTHI1 " + GGR(setlist[1]);
        case 18: return "MFLO1 " + GGR(setlist[3]);
        case 19: qDebug() << Q_FUNC_INFO << "MTLO1" << GGR(setlist[1]) << GGR(setlist[2]) << GGR(setlist[3]);
        return "MTLO1 " + GGR(setlist[1]);
