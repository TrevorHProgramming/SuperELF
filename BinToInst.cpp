...
QString MainWindow::convToInstruction(QString input) {
    ...
    int setji = setj.toInt(nullptr, 2);
    ...
    case 2: return "J " + QString::number(setlist[7]);
    case 3: return "JAL " + QString::number(setlist[7]);
    case 4: return "BEQ " + GGR(setlist[1]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[6]);
    case 5: return "BNE " + GGR(setlist[1]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[6]);
    case 6: return "BLEZ " + GGR(setlist[1]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[6]);
    case 7: return "BGTZ " + GGR(setlist[1]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[6]);
    case 8: return "ADDI " + GGR(setlist[2]) + ", " + GGR(setlist[1]) + ", " + QString::number(setlist[6]);
    case 9: return "ADDIU " + GGR(setlist[2]) + ", " + GGR(setlist[1]) + ", " + QString::number(setlist[6]);
    case 10: return "SLTI " + GGR(setlist[2]) + ", " + GGR(setlist[1]) + ", " + QString::number(setlist[6]);
    case 11: return "SLTIU " + GGR(setlist[2]) + ", " + GGR(setlist[1]) + ", " + QString::number(setlist[6]);
    case 12: return "ANDI " + GGR(setlist[2]) + ", " + GGR(setlist[1]) + ", " + QString::number(setlist[6]);
    case 13: return "ORI " + GGR(setlist[2]) + ", " + GGR(setlist[1]) + ", " + QString::number(setlist[6]);
    case 14: return "XORI " + GGR(setlist[2]) + ", " + GGR(setlist[1]) + ", " + QString::number(setlist[6]);
    case 15: return "LUI " + GGR(setlist[1]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[6]);
    case 20: return "BEQL " + GGR(setlist[1]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[6]);
    case 21: return "BNEL " + GGR(setlist[1]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[6]);
    case 22: return "BLEZL " + GGR(setlist[1]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[6]);
    case 23: return "BGTZL " + GGR(setlist[1]) + ", " + GGR(setlist[2]) + ", " + QString::number(setlist[6]);
    case 24: return "DADDI " + GGR(setlist[2]) + ", " + GGR(setlist[1]) + ", " + QString::number(setlist[6]);
    case 25: return "DADDIU " + GGR(setlist[2]) + ", " + GGR(setlist[1]) + ", " + QString::number(setlist[6]);
    case 26: return "LDL " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 27: return "LDR " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 30: return "LQ " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 31: return "SQ " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 32: return "LB " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 33: return "LH " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 34: return "LWL " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 35: return "LW " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 36: return "LBU " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 37: return "LHU " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 38: return "LWR " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 39: return "LWU " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 40: return "SB " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 41: return "SH " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 42: return "SWL " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 43: return "SW " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 44: return "SDL " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 45: return "SDR " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 46: return "SWR " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 47: return "CACHE";
    case 49: return "LWC1 " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 51: return "PREF " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 54: return "LQC2";
    case 55: return "LD " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 57: return "SWC1 " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
    case 62: return "SQC2";
    case 63: return "SD " + GGR(setlist[2]) + ", " + QString::number(setlist[6]) + "(" + GGR(setlist[1]) +")";
